...
function Profile(props) {
	...
	useEffect(() => {
		...
		axios.get(`${apiConfig}users/${props.match.params.id}`)
			.then((response) => {
				...
				axios.get(`${apiConfig}users/${props.match.params.id}/reviews`)
				.then((response) => {
					...
					<div id="infos" className="col-span-3">
						<div className="bg-white shadow overflow-hidden rounded-lg">
							...
							<div className="px-4 py-5 sm:px-6">
								<div className="w-full lg:flex pointer-events-none">
									<OfferUser user={user} />
								</div>
							</div>
							...
							<div className="border-t border-secondary mx-10"></div>
								...
								{ ( props.match.params.id == props.sign.user.id ) ? (
								<form>
										...
										<div className="grid grid-cols-2 gap-4">
											...
											<div className="bg-secondary-light-2 overflow-hidden rounded-lg px-4 py-3">
												<div className="flex items-center text-secondary">
													...
													<div className="font-bold text-l">Profil privé</div>
												</div>
												<div className="w-full max-w-xs mx-auto mt-3">
													<Switch.Group as="div" className="flex items-center">
														<Switch
